class Restaurants
  ...
  #------------------------------------------------------------------------------------
  def initialize(name, formatted_address, opening_hours, rating, user_ratings_total, place_id) #, formatted_address, opening_hours, rating, user_ratings_total)  # this method creates a new instances of a
